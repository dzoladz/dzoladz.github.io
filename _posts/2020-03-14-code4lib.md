...
<div class="row justify-content-center">
    <div class="col-sm-8 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/blog/pittsburgh-bus.jpg" title="Everything is an app" caption="Pittsburgh port authority bus projecting upward from a sinkhole in the middle of a downtown street" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<div class="row justify-content-center">
    <div class="col-sm-4 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/blog/hyku_for_consortia.png " title="Hexagon-shaped sticker showing Hyku for Consortia logo" caption="Hexagon-shaped sticker showing Hyku for Consortia logo" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
