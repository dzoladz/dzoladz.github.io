...
<div class="row justify-content-center">
    <div class="col-sm-10 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/blog/2025drupalcon/new_navigation.png" title="New navigation mockup" caption="New Navigation Mock-up" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
